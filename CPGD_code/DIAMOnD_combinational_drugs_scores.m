function [scores]=DIAMOnD_combinational_drugs_scores(GO_sim_data,gene_list,Targets1,Targets2,Breast_genes_set,CC);  
...
[G0_scores] = calculate_GO_scores(GO_sim_data,s1,s2);


scores=scores1*scores2*scores3*G0_scores;
